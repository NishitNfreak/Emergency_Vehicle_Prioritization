...
o	Prints which direction has the emergency vehicle.
o	Sets that direction to green and others to red.
o	Simulates the green light for 60 seconds.
5.	After the emergency clears, it restores normal signal cycles.
________________________________________
7. Tech Stack
